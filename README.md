...
|------|--------|------|--------|
| WWV | [WWV](https://www.nist.gov/pml/time-and-frequency-division/time-distribution/radio-station-wwv) | CHU | [CHU](https://nrc.canada.ca/en/certifications-evaluations-standards/canadas-official-time/nrc-shortwave-station-broadcasts-chu)
| WSPR | [WSPR](https://wspr.rocks/) | FST4W | [FST4W](https://www.wsprdaemon.org/fst4w) |
