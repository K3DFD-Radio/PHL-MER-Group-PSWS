...
10. Next, click on this [Configuration](https://github.com/K3DFD-Radio/PHL-MER-Group-PSWS/blob/main/hardware.md) link to install and configure the WSPRdaemon SDR environment.
